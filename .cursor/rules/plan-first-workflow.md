...
1. **Enter Plan Mode** — use plan mode for complex tasks
...
**When to use:**
- Task is high-level or vague ("improve the analysis", "write the paper")
...
**Protocol:**
1. Ask clarifying questions (max 3-5 questions)
...
- Use MEMORY.md for persistent corrections
